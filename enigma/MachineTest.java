...
public class MachineTest {
    ...
    public void testSetRotors() {
        Machine mach = mach1();
        assertEquals(0, mach.getRotor(1)._setting);
        assertEquals(23, mach.getRotor(2)._setting);
        assertEquals(11, mach.getRotor(3)._setting);
        assertEquals(4, mach.getRotor(4)._setting);
    }
